...
<div class="question-wrap question-name question-new" data-id="<?= $groupNamePrefix; ?>">
    <div class="box-shadow question-content">
        ...
        <input type="hidden" name="type_<?= $groupNamePrefix; ?>" value="name">
        ...
        <div class="name-answers">
            <div class="answer-wrap">
                <textarea rows="1" placeholder="Имя" style="overflow: hidden; height: 25px;"></textarea>
            </div>
            <div class="answer-wrap">
                <textarea rows="1" placeholder="Отчество" style="overflow: hidden; height: 25px;"></textarea>
            </div>
            <div class="answer-wrap">
                <textarea rows="1" placeholder="Фамилия" style="overflow: hidden; height: 25px;"></textarea>
            </div>
        </div>
    </div>
