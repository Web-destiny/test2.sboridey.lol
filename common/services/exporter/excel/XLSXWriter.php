...
namespace common\services\exporter\excel;
...
//        $filename = tempnam('var/tmp', "xlsx_writer_");
...
//        }
    ...
    //------------------------------------------------------------------
    public static function convert_date_time($date_input) //thanks to Excel::Writer::excel::Worksheet.pm (perl)
    {
